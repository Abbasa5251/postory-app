...
// NODE_ENV read directly: it's a Next.js build-time constant, not a secret,
// and t3-env does not model it.
if (process.env.NODE_ENV === "production" && EMAIL_FROM === SANDBOX_FROM) {
  throw new Error(
